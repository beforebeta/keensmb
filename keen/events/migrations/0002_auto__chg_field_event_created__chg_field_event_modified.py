...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Event.modified'
        db.alter_column(u'events_event', 'modified', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Event.modified'
        db.alter_column(u'events_event', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'events.event': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'occurrence_datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)'})
        }
    }
