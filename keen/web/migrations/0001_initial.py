...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageCustomerField'
        db.create_table(u'web_pagecustomerfield', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('page', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Client'])),
        ))
        db.send_create_signal(u'web', ['PageCustomerField'])
        ...
        db.create_unique(m2m_table_name, ['pagecustomerfield_id', 'hstorefieldcatalog_id'])

        # Adding model 'SignupForm'
        db.create_table(u'web_signupform', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Client'])),
        ...
        db.send_create_signal(u'web', ['SignupForm'])


    def backwards(self, orm):
        # Deleting model 'PageCustomerField'
        db.delete_table(u'web_pagecustomerfield')
        ...
        db.delete_table(u'web_signupform')
    ...
    models = {
        ...
        u'web.pagecustomerfield': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'fields': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.HStoreFieldCatalog']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
