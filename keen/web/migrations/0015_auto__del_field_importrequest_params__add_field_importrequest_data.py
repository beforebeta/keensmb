...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ImportRequest.params'
        db.delete_column(u'web_importrequest', 'params')

        # Adding field 'ImportRequest.data'
        db.add_column(u'web_importrequest', 'data',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ImportRequest.params'
        db.add_column(u'web_importrequest', 'params',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)

        # Deleting field 'ImportRequest.data'
        db.delete_column(u'web_importrequest', 'data')
