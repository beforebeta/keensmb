...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrialRequest.question'
        db.add_column(u'web_trialrequest', 'question',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'TrialRequest.comments'
        db.add_column(u'web_trialrequest', 'comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrialRequest.question'
        db.delete_column(u'web_trialrequest', 'question')

        # Deleting field 'TrialRequest.comments'
        db.delete_column(u'web_trialrequest', 'comments')
