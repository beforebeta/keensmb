...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SignupForm.submission_confirmation_sender'
        db.add_column(u'web_signupform', 'submission_confirmation_sender',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SignupForm.submission_confirmation_sender'
        db.delete_column(u'web_signupform', 'submission_confirmation_sender')
