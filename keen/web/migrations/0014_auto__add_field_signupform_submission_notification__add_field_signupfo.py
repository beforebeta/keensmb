...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SignupForm.submission_notification'
        db.add_column(u'web_signupform', 'submission_notification',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SignupForm.signup_confirmation_subject'
        db.add_column(u'web_signupform', 'signup_confirmation_subject',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SignupForm.submission_confirmation_html'
        db.add_column(u'web_signupform', 'submission_confirmation_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SignupForm.submission_notification'
        db.delete_column(u'web_signupform', 'submission_notification')

        # Deleting field 'SignupForm.signup_confirmation_subject'
        db.delete_column(u'web_signupform', 'signup_confirmation_subject')

        # Deleting field 'SignupForm.submission_confirmation_html'
        db.delete_column(u'web_signupform', 'submission_confirmation_html')
