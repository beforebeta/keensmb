...
urlpatterns = patterns(
    ...
    url(r'^customer_profile/(?P<customer_id>[\d]+)', 'client.profile',
        name='client_profile'),
    url(r'^business_profile', 'client.business_profile',
        name='business_profile'),
    url(r'^signup-form/create$', 'client.signup_form_create',
        name='signup_form_create'),
    url(r'^signup-form/list$', 'client.signup_form_list',
        name='client_signup_form_list'),
    url(r'^signup-form/(?P<slug>[\w-]+)/edit$', 'client.signup_form_edit',
        name='client_signup_form_edit'),
    url(r'^signup-form/(?P<slug>[\w-]+)/preview$', 'client.signup_form_preview',
        name='client_signup_form_preview'),
