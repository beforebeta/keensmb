...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerField.group_ranking'
        db.add_column(u'core_customerfield', 'group_ranking',
                      self.gf('django.db.models.fields.IntegerField')(default=99999999),
                      keep_default=False)


        # Changing field 'CustomerField.type'
        db.alter_column(u'core_customerfield', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting field 'CustomerField.group_ranking'
        db.delete_column(u'core_customerfield', 'group_ranking')


        # Changing field 'CustomerField.type'
        db.alter_column(u'core_customerfield', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
