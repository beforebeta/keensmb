...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Promotion.cta_text'
        db.alter_column(u'core_promotion', 'cta_text', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Promotion.cta_text'
        db.alter_column(u'core_promotion', 'cta_text', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
