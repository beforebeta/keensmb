...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'core_image', 'url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Deleting field 'Image.file'
        db.delete_column(u'core_image', 'file')

        # Deleting field 'Image.content_type'
        db.delete_column(u'core_image', 'content_type')
