...
ALT_TITLES = {
    'social__facebook': 'Facebook Profile URL',
    'social__googleplus': 'Google Plus Profile URL',
    'social__twitter': 'Twitter Handle',
    'has_children': 'Do you have children?',
    'interest__arts': 'Interested in Arts & Crafts?',
    'interest__blogging': 'Interested in Blogging?',
    'interest__books': 'Interested in Books?',
    'interest__business': 'Interested in Business?',
    'interest__health': 'Interested in Health/Wellness?',
    'interest__news': 'Interested in Current Events?',
    'marital_status': 'Married?',
    'purchase__charitable': 'Do you donate to charity?',
    'purchase__automotive': 'Do you own a car?',
    'purchase__baby': 'Do you buy baby products?',
    'purchase__beauty': 'Do you buy beauty products?',
    'purchase__cooking': 'Interested in Cooking?',
    'purchase__discount': 'Interested in discounts?',
    'purchase__home_improvement': 'Do you buy home/garden items?',
    'purchase__luxury': 'Do you buy luxury items?',
    'purchase__magazine': 'Do you subscribe to magazines?',
    'purchase__outdoor': 'Do you buy outdoor gear?',
    'purchase__pets': 'Do you buy pet products?',
    'purchase__sports': 'Do you buy sporting goods?',
    'purchase__technology': 'Do you buy technology products?',
    'purchase__travel': 'Do you buy travel products?',
}
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerField.alt_title'
        db.add_column(u'core_customerfield', 'alt_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CustomerField.hidden'
        db.add_column(u'core_customerfield', 'hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        for name in ALT_TITLES:
            orm.CustomerField.objects.filter(name=name).update(alt_title=ALT_TITLES[name])

        for name in HIDDEN:
            orm.CustomerField.objects.filter(name=name).update(hidden=True)

    def backwards(self, orm):
        # Deleting field 'CustomerField.alt_title'
        db.delete_column(u'core_customerfield', 'alt_title')

        # Deleting field 'CustomerField.hidden'
        db.delete_column(u'core_customerfield', 'hidden')
