...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomerSource.ref_id'
        db.alter_column(u'core_customersource', 'ref_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'CustomerSource.ref_source'
        db.alter_column(u'core_customersource', 'ref_source', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'CustomerSource.ref_id'
        db.alter_column(u'core_customersource', 'ref_id', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'CustomerSource.ref_source'
        db.alter_column(u'core_customersource', 'ref_source', self.gf('django.db.models.fields.CharField')(default=None, max_length=50))
