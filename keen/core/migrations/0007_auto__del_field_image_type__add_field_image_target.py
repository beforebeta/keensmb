...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Image.type'
        db.delete_column(u'core_image', 'type')

        # Adding field 'Image.target'
        db.add_column(u'core_image', 'target',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Image.type'
        db.add_column(u'core_image', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1),
                      keep_default=False)

        # Deleting field 'Image.target'
        db.delete_column(u'core_image', 'target')
