...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.ref_id_type'
        db.add_column(u'core_client', 'ref_id_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Client.ref_id'
        db.add_column(u'core_client', 'ref_id',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.ref_id_type'
        db.delete_column(u'core_client', 'ref_id_type')

        # Deleting field 'Client.ref_id'
        db.delete_column(u'core_client', 'ref_id')
