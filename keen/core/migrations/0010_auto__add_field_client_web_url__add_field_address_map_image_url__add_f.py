...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.web_url'
        db.add_column(u'core_client', 'web_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Address.map_image_url'
        db.add_column(u'core_address', 'map_image_url',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Promotion.cta_text'
        db.add_column(u'core_promotion', 'cta_text',
                      self.gf('django.db.models.fields.CharField')(default='Redeem', max_length=50),
                      keep_default=False)

        # Adding field 'Promotion.send_later'
        db.add_column(u'core_promotion', 'send_later',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Promotion.short_code'
        db.alter_column(u'core_promotion', 'short_code', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Promotion.valid_to'
        db.alter_column(u'core_promotion', 'valid_to', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Promotion.redemption_instructions'
        db.alter_column(u'core_promotion', 'redemption_instructions', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Promotion.valid_from'
        db.alter_column(u'core_promotion', 'valid_from', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Promotion.name'
        db.alter_column(u'core_promotion', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):
        # Deleting field 'Client.web_url'
        db.delete_column(u'core_client', 'web_url')

        # Deleting field 'Address.map_image_url'
        db.delete_column(u'core_address', 'map_image_url')

        # Deleting field 'Promotion.cta_text'
        db.delete_column(u'core_promotion', 'cta_text')

        # Deleting field 'Promotion.send_later'
        db.delete_column(u'core_promotion', 'send_later')


        # Changing field 'Promotion.short_code'
        db.alter_column(u'core_promotion', 'short_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Promotion.valid_to'
        db.alter_column(u'core_promotion', 'valid_to', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Promotion.redemption_instructions'
        db.alter_column(u'core_promotion', 'redemption_instructions', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Promotion.valid_from'
        db.alter_column(u'core_promotion', 'valid_from', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Promotion.name'
        db.alter_column(u'core_promotion', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
