...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerField.is_unique'
        db.add_column(u'core_customerfield', 'is_unique',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerField.is_unique'
        db.delete_column(u'core_customerfield', 'is_unique')
