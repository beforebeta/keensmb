...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_clientuser', (
        ...
        db.send_create_signal(u'core', ['ClientUser'])

        # Adding unique constraint on 'ClientUser', fields ['client', 'user']
        db.create_unique(u'core_clientuser', ['client_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClientUser', fields ['client', 'user']
        db.delete_unique(u'core_clientuser', ['client_id', 'user_id'])

        # Deleting model 'ClientUser'
        db.delete_table(u'core_clientuser')
