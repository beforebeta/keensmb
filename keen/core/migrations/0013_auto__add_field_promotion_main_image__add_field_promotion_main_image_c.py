...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotion.main_image'
        db.add_column(u'core_promotion', 'main_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Promotion.main_image_cropping'
        db.add_column(u'core_promotion', 'main_image_cropping',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Promotion.main_image'
        db.delete_column(u'core_promotion', 'main_image')

        # Deleting field 'Promotion.main_image_cropping'
        db.delete_column(u'core_promotion', 'main_image_cropping')
    ...
    models = {
        ...
        u'core.promotion': {
            ...
            'main_image_cropping': (u'django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
