...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_customer', 'visitor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracking.Visitor'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.visitor'
        db.delete_column(u'core_customer', 'visitor_id')
