...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.signup_form_code'
        db.add_column(u'core_client', 'signup_form_code',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.signup_form_code'
        db.delete_column(u'core_client', 'signup_form_code')
    ...
    models = {
        ...
        u'core.client': {
            ...
            'signup_form_code': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
