...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_image', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Image.file'
        db.alter_column(u'core_image', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
