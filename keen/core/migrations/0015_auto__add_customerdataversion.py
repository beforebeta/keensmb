...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomerDataVersion'
        db.create_table(u'core_customerdataversion', (
            ...
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data_history', to=orm['core.Customer'])),
        ...
        db.send_create_signal(u'core', ['CustomerDataVersion'])


    def backwards(self, orm):
        # Deleting model 'CustomerDataVersion'
        db.delete_table(u'core_customerdataversion')
    ...
    models = {
        ...
        u'core.customerdataversion': {
            'Meta': {'object_name': 'CustomerDataVersion'},
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'data_history'", 'to': u"orm['core.Customer']"}),
            'data': ('django_hstore.fields.DictionaryField', [], {'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'})
        },
