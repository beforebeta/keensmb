...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Promotion.target_audience'
        db.add_column(u'core_promotion', 'target_audience',
    ...
    def backwards(self, orm):
        # Deleting field 'Promotion.target_audience'
        db.delete_column(u'core_promotion', 'target_audience')
